...
The v2 cut inserts `release/EvalPilot-model-plan-slide.png` from 1:10 to 1:25. It shows the actual DeepSeek V4 Pro replay plan, the 8/8 comparison with deterministic planning, token cost, and the validation boundary. Published at https://www.bilibili.com/video/BV1mPYY6sE1k; direct MP4 backup: https://n.uguu.se/AFnrdUSF.mp4.
